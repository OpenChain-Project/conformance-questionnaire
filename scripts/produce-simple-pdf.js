...
var logofilename = path.join(__dirname, "../scripts/images/openchainlogo-wide.png");
var questiongraphic_filename = path.join(__dirname, "../scripts/images/question-graphic.png");
